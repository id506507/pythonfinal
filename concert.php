...
<?php
	...
	if ( !( $result = mysqli_query($database,"SELECT * FROM concert") ) )//是否可以query
         {
            print( "<p>Could not execute query!</p>" );
            die( mysql_error() . "</body></html>" );
         }
    $result=mysqli_query($database,"SELECT artist FROM concert ORDER BY at DESC"); //抓DB裡的data
    $result1=mysqli_query($database,"SELECT content FROM concert ORDER BY at DESC"); //抓DB裡的data
    $result2=mysqli_query($database,"SELECT at FROM concert ORDER BY at DESC"); //抓DB裡的data
			...
			<div class="nav-top">
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li class="active"><a href="concert.php">演唱會</a></li>
					</ul>
					<div class="clearfix"> </div>
					<!-- script-for-menu -->
							 <script> 
